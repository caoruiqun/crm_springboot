...
<script type="text/javascript">
	...
	$(function(){
		...
		//为搜索市场活动的文本框绑定事件，根据市场活动名称模糊查询市场活动列表
		$("#aname").keydown(function (event) {

			//如果敲的是回车键
			if(event.keyCode==13){

				//查询市场活动信息列表，展现市场活动信息列表
				//alert("查询市场活动信息列表，展现市场活动信息列表");
				$.ajax({
		...
		$("#bundBtn").click(function () {
			...
			// param:cid=xxx&aid=xxx&aid=xxx&aid=xxx
			...
			$.ajax({
				...
				success : function (data) {
					...
					if(data.success){
						...
						//清空搜索市场活动模态窗口中的信息列表，将全选的复选框的√灭掉
			...
			success : function (data) {
				...
				$.each(data,function (i,n) {
					...
					/*
						...
						解除关联是关联关系表的删除操作，既然是要做删除操作，那么肯定是根据id删除记录最方便的

						为解除关联的方法unbund里面传递的参数，就应该是关联关系表的id，而不是市场活动的id

						所以我们在查询市场活动表的时候，就应该将市场活动的id处理为关联关系表的id
...
<body>
                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" style="width: 300px;">
                                <input type="text" class="form-control" id="edit-company" value="恩诺国际">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" style="width: 300px;">
                                <input type="text" class="form-control" id="edit-email" value="lisi@enroll.com">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" style="width: 300px;">
                                <input type="text" class="form-control" id="edit-website" value="http://www.enroll.com">
                            </div>
                        </div>
                        ...
                        <div style="position: relative;top: 15px;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10" style="width: 300px;">
                                    <input type="text" class="form-control" id="edit-nextContactTime" value="2016-05-01">
                                </div>
                            </div>
                        </div>
	...
	<div style="position: relative; top: 40px; left: 40px;">
		...
		<div class="remarkDiv" style="height: 60px;">
			...
			<div style="position: relative; top: -40px; left: 40px;" >
				<h5>哎呦！</h5>
				<font color="gray">线索</font> <font color="gray">-</font> <b>李四先生-恩诺国际</b> <small style="color: gray;"> 2016-01-22 10:10:10 由zhangsan</small>
		...
		<div class="remarkDiv" style="height: 60px;">
			...
			<div style="position: relative; top: -40px; left: 40px;" >
				<h5>呵呵！</h5>
				<font color="gray">线索</font> <font color="gray">-</font> <b>李四先生-恩诺国际</b> <small style="color: gray;"> 2016-01-22 10:20:10 由zhangsan</small>
				<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
					<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #E6E6E6;"></span></a>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #E6E6E6;"></span></a>
	...
	<div>
		<div style="position: relative; top: 60px; left: 40px;">
			...
			<div>
				<a href="javascript:void(0);" id="openBundModalBtn" style="text-decoration: none;"><span class="glyphicon glyphicon-plus"></span>关联市场活动</a>
			</div>
		</div>
	</div>

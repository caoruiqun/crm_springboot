<%@ page import="com.taikang.crm.workbench.model.Tran" %>
<%@ page import="com.taikang.crm.setting.model.DicValue" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.Map" %>
<%@ page import="com.taikang.crm.config.PropertiesListenerConfig" %>
...
<script type="text/javascript">
   ...
   /* function showStage() {
        $.ajax({
            ...
            url : "workbench/transaction/getStageInfo.do",
            data : {
            ...
            success : function (data) {
                ...
                $.each(data.id,function (i,n) {
                    ...
                    html += '<div style="position: relative; left: 40px; top: -50px;">';

                    html += '<span id="'+n.id+'" onclick="changeStage(\''+n.listStage+'\',\''+n.id+'\')"  class="glyphicon glyphicon-remove mystage"  data-toggle="popover" data-placement="bottom" data-content="'+n.dataContent+'" style="color: #FF0000;"></span>';
			...
			if("0".equals(currentPossibility)){
				...
				for(int i=0;i<dvList.size();i++){
					...
					%>
						...
						<span id="<%=i%>" onclick="changeStage('<%=dv.getValue()%>','<%=i%>')"
	...
	<div style="position: relative; top: 100px; left: 40px;">
		...
		<div class="remarkDiv" style="height: 60px;">
			...
			<div style="position: relative; top: -40px; left: 40px;" >
				<h5>哎呦！</h5>
				<font color="gray">交易</font> <font color="gray">-</font> <b>恩诺国际-交易01</b> <small style="color: gray;"> 2016-01-22 10:10:10 由zhangsan</small>
		...
		<div class="remarkDiv" style="height: 60px;">
			...
			<div style="position: relative; top: -40px; left: 40px;" >
				<h5>呵呵！</h5>
				<font color="gray">交易</font> <font color="gray">-</font> <b>恩诺国际-交易01</b> <small style="color: gray;"> 2016-01-22 10:20:10 由zhangsan</small>
				<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
					<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #E6E6E6;"></span></a>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #E6E6E6;"></span></a>

                    ...
                    $.each(data,function (i,n) {
                        ...
                        /*
                            ...
                            href="javascript:void(0);"
                                表示禁用超链接，组件必须以触发事件的形式来控制行为

                            通过循环的方式动态生成的元素，我们不能以起id属性的形式为元素绑定事件
                            如果是这种情况，我们通常使用的形式传统的触发事件的形式
...
<div style="position: relative; top: 30px; left: 40px;" id="remarkBody">
    ...
    <%--<div class="remarkDiv" style="height: 60px;">
        ...
        <div style="position: relative; top: -40px; left: 40px;" >
            <h5>哎呦！</h5>
            <font color="gray">市场活动</font> <font color="gray">-</font> <b>发传单</b> <small style="color: gray;"> 2016-01-22 10:10:10 由zhangsan</small>
    ...
    <%--<div class="remarkDiv" style="height: 60px;">
        ...
        <div style="position: relative; top: -40px; left: 40px;" >
            <h5>呵呵！</h5>
            <font color="gray">市场活动</font> <font color="gray">-</font> <b>发传单</b> <small style="color: gray;"> 2016-01-22 10:20:10 由zhangsan</small>
            <div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
                <a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #E6E6E6;"></span></a>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #E6E6E6;"></span></a>
